...
while menu != "7":
    ...
    if menu == "1":
        ...
        print("\n\t\t\t\t\t","=" * 10," PENJUALAN OBAT ","=" * 10)
        print("\n\t\t\t Kode\tNama Obat\t\tHarga\tStok")
        print("\t\t\t","-" * 50)
        for o in obat:
        ...
        if jenis_kelamin == "L":
            ...
            jenis_kelamin = "Tidak diketahui"
        keluhan = input("\t\t\t Keluhan Utama: ")
        pasien_list.append([nama, umur, jenis_kelamin, keluhan])
        ...
        if jenis_kelamin == "L":
            ...
            jenis_kelamin = "Tidak diketahui"
        pasien_list.append([nama, umur, jenis_kelamin])
